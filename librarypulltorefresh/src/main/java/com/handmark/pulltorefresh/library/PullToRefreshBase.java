...
import com.handmark.pulltorefresh.library.internal.CustomizeLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(a.hasValue(R.styleable.PullToRefresh_ptrIsNested)){
            isNested = a.getBoolean(R.styleable.PullToRefresh_ptrIsNested,false);
        }
...
//                    return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
                    return new CustomizeLoadingLayout(context, mode, scrollDirection, attrs);
                case FLIP:
