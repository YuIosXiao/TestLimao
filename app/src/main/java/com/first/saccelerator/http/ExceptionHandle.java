...
/**
 * Created by XQ on 2017/10/31.
 * 网络请求  异常处理类
 */
public class ExceptionHandle {

    private static final int UNAUTHORIZED = 401;//未授权：登录失败
    private static final int FORBIDDEN = 403;//访问被拒绝
    private static final int NOT_FOUND = 404;//找不到网页，地址错误
    ...
    private static final int SERVICE_UNAVAILABLE = 503;//服务器错误
