...
//        System.out.println("UUID----->" + uuid.toString());
    ...
    public static List<String> getUserIMEI() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {//5.0以后
            String imei1 = getDeviced(StaticStateUtils.basisActivity, 0);//第一个插槽
            String imei2 = getDeviced(StaticStateUtils.basisActivity, 1);//第二个插槽
            if (StringUtils.isBlank(imei1) && StringUtils.isBlank(imei2)) {
                String imei3 = getimei(StaticStateUtils.basisActivity);
            ...
            String imei1 = getimei(StaticStateUtils.basisActivity);
    ...
    public static List<String> getUserIMSI() {
        List<String> list = new ArrayList<>();
        if (Build.VERSION.SDK_INT >= 21) {//5.0以后
            String sim1 = getSubscriberId(StaticStateUtils.basisActivity, getSubId(StaticStateUtils.basisActivity, 0));//第一个插槽
            String sim2 = getSubscriberId(StaticStateUtils.basisActivity, getSubId(StaticStateUtils.basisActivity, 1));//第二个插槽
            ...
            if (StringUtils.isBlank(sim1) && StringUtils.isBlank(sim2)) {
                String sim3 = getimsi(StaticStateUtils.basisActivity);
                if (!StringUtils.isBlank(sim3)) {
                    list.add(sim3);
                }
            }
        } else {
            String sim1 = getimsi(StaticStateUtils.basisActivity);
            if (!StringUtils.isBlank(sim1)) {
                list.add(sim1);
            }
        }
